<x-layout-app page-title="Editar colaborador">
    <div class="w-40 p-4 mb-5">
        ...
        <hr>
        <form action="{{ route('colaborators.update') }}" method="post">
            @csrf
            <input type="text" name="id" value="{{ Crypt::encryptString($colaborator->id) }}" hidden>
                                ...
                                <select class="form-select" name="department_id" id="department_id">
                                    @foreach ($departments as $department)
                                        <option value="{{ $department->id }}"
                                            {{ $department->id === $colaborator->department->id ? 'selected' : '' }}>
                                            {{ $department->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                @foreach ($permissions as $permission)
                                    <div class="form-check me-3">
                                        <input class="form-check-input" type="checkbox"
                                            ...
                                            value="{{ true }}"
                                            {{ isset($colaborator->permissions[$permission]) && $colaborator->permissions[$permission] ? 'checked' : '' }}>
                    ...
                    <div class="col rounded border border-black p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="address" name="address"
                                value="{{ old('address', $colaborator->userDetail->address) }}">
                            @error('address')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="zip_code" name="zip_code"
                                        value="{{ old('zip_code', $colaborator->userDetail->zip_code) }}">
                                    @error('zip_code')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="city" name="city"
                                        value="{{ old('city', $colaborator->userDetail->city) }}">
                                    @error('city')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone"
                                        value="{{ old('phone', $colaborator->userDetail->phone) }}">
                                    @error('phone')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="salary" name="salary"
                                        ...
                                        value="{{ number_format(old('salary', $colaborator->userDetail->salary), 2, ',', '') }}">
                                    @error('salary')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="admission_date"
                                        ...
                                        value="{{ old('admission_date', $colaborator->userDetail->admission_date) }}">
